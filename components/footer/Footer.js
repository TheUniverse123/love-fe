            ...
            <div className="container">
                <div className="row">
                    <div className={`col-lg-4 col-md-6 col-sm-12 ${styles.footerWrapper}`}>
                        <div ><Link className="d-inline-block mb-20" href="index.html">
                            <Logo />
                        </Link>
                    ...
                    <div className={`col-lg-4 col-md-6 col-sm-12 ${styles.footerWrapper}`}>
                        <div className="mb-2">
                            ...
                            <ul className="menu-footer">
                                <li className="mb-10"><Link href="#">Chính sách bảo mật thông tin</Link></li>
                                <li><Link href="#">Chính sách bảo mật thanh toán</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className="mb-2">
                            ...
                            <ul className="menu-footer">
                                <li className="mb-10"><Link href="#">Điều khoản sử dụng cho ban tổ chức</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className="mb-2">
                            ...
                            <ul className="menu-footer">
                                <li className="mb-10"><Link href="#">Điều khoản sử dụng cho Khách hàng</Link></li>
                            </ul>
                        </div>
                    </div>
                    <div className={`col-lg-4 col-md-6 col-sm-12 ${styles.footerWrapper}`}>
                        <div className="mb-2">
                            ...
                            <ul className="menu-footer">
                                <li className="mb-10"><Link href="#">Hướng dẫn đặt vé</Link></li>
                                <li><Link href="#">Trung tâm trợ giúp</Link></li>
                            </ul>
                        </div>
                        <div className="mb-2">
                ...
                <div className="footer-bottom mt-50">
                    <div className="row align-items-center">
                        <div className="col-md-6 text-md-start text-center mb-20">
                            <p className="text-sm color-white">© 2025 Lové Inc. All rights reserved.</p>
                        </div>
