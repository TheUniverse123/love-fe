            ...
            <div className="container">
                <div className="row align-items-end">
                    <div className="col-lg-7 wow fadeInUp">
                        <h1 className="white-color mt-15 mb-15"> <span>Chào mừng đến với </span><br />Trung tâm hỗ trợ</h1>
                        <p className="text-xl-medium neutral-500">Bạn có câu hỏi nào không? Chúng tôi rất sẵn lòng giúp bạn.</p>
                    </div>
                </div>
                <div className="row mt-60">
                    <div className="col-lg-3 col-sm-6">
                        <div className="card-contact main-background border-color">
                            <div className="card-image">
                                <div className="card-icon border-1px-white">
                                    <svg width={20} height={22} viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10 11.75C6.83 11.75 4.25 9.17 4.25 6C4.25 2.83 6.83 0.25 10 0.25C13.17 0.25 15.75 2.83 15.75 6C15.75 9.17 13.17 11.75 10 11.75ZM10 1.75C7.66 1.75 5.75 3.66 5.75 6C5.75 8.34 7.66 10.25 10 10.25C12.34 10.25 14.25 8.34 14.25 6C14.25 3.66 12.34 1.75 10 1.75Z" fill />
                                        <path d="M18.5901 21.75C18.1801 21.75 17.8401 21.41 17.8401 21C17.8401 17.55 14.3202 14.75 10.0002 14.75C5.68015 14.75 2.16016 17.55 2.16016 21C2.16016 21.41 1.82016 21.75 1.41016 21.75C1.00016 21.75 0.660156 21.41 0.660156 21C0.660156 16.73 4.85015 13.25 10.0002 13.25C15.1502 13.25 19.3401 16.73 19.3401 21C19.3401 21.41 19.0001 21.75 18.5901 21.75Z" fill />
                                    </svg>
                                </div>
                            </div>
