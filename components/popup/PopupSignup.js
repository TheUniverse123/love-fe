            ...
            <div className="popup-container border-0px">
                <div className="main-secondary-background" style={{ borderRadius: "16px" }}>
                    ...
                    <div className={`popup-content pt-40 ${styles.popupBody}`}>
                        <a className="close-popup-signup border-background" />
                        <div className="form-login">
                            <form action="#">
                                ...
                                <p class="text-sm-medium neutral-500">Đã có tài khoản?  <a class="primary-color-2 btn-signin" href="#">Đăng nhập ngay!</a></p>
